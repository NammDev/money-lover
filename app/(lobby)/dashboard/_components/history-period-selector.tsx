...
import { GetHistoryPeriodsResponseType, getHistoryPeriods } from '@/lib/actions/history'
...
function HistoryPeriodSelector({ period, setPeriod, timeframe, setTimeframe, userId }: Props) {
