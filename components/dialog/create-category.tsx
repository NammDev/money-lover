...
import { CreateCategorySchema, CreateCategorySchemaType } from '@/lib/schemas/categories'
...
function CreateCategoryDialog({ type, successCallback, trigger, userId }: Props) {
  ...
  const { mutate, isPending } = useMutation({
    mutationFn: (values: CreateCategorySchemaType) => createCategory(userId, values),
